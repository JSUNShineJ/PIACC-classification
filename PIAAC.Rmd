...
cat("deleted", length(remove_var), "columns\n")

```

#select columns with a prop less than or equal to 0.35 and have missing values， use KNN to fill missing values
